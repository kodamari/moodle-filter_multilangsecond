...
namespace filter_multilangsecond;
...
class text_filter extends \core_filters\text_filter {
    ...
    public function filter($text, array $options = array()) {
        ...
        $result = preg_replace_callback($search, array($this, $callback), $text);
        ...
        if ($CFG->filter_multilangsecond_mode > 1)
            $result = preg_replace_callback($search0, array($this, $callback0), $result);
